...
!
  ...
  integer(i_kind) :: mlake_counted(2000,2000)
  integer(i_kind) :: ilake_pt_counted(2000,2000)
  integer(i_kind) :: npts_mlake(2000)
  integer(i_kind) :: istart_mlake(2000)
  integer(i_kind) :: jstart_mlake(2000)
...
! Points below are for RAP domain 
!  data ilakecen / 580, 590, 613, 632, 645, 428, 445 /
!  data jlakecen / 379, 343, 363, 348, 365, 516, 482 /
! data ilakecen / 580, 590, 605, 632, 645, 428, 445 /
! data jlakecen / 379, 343, 373, 348, 365, 516, 482 /

! data ilakecen /1130,1178,1301,1362,1430,1303,1595/ 
! data jlakecen / 892, 748, 796, 708, 772, 704,1003/
!  1/2/3/4/5 = Superior, Michigan/Huron, N. Channel/Huron,Erie, Ontario
!  6/7       = Lake St. Clair, Gulf of St. Lawrence
 

  data ilakecen /1130,1178,1301,1362,1430,1595,1303/ 
  data jlakecen / 892, 748, 796, 708, 772,1003, 704/
!  1/2/3/4/5 = Superior, Michigan/Huron, N. Channel/Huron,Erie, Ontario
!  6/7       = Gulf of St. Lawrence, Lake St. Clair
...
!  flnm2='geo_em.d01.nc.gslsnip' ! has a surgery on the Great Salt Lake
   flnm2='geo_em.d01.nc.fixlake-noGreatLakes'
