...
!           files to compute maximum RH over the previous 12 hours.
...
!
! outputs:  maxRH field (binary IEEE file) for analysis and/or guess file.
!           Naming style is: hiurma.${PDYm1}.maxrh_anl.dat
