...
!
  write(6,*) '================================================='
!  rmse_var='SMOIS'
  write(*,*)'Before getting dimensions of SMC (SMOIS) '
  call GET_DIM_ATT_fv3sar_sfcdata(sfcvars,nlon_regional_smc,nlat_regional_smc,nsig_regional_smc)
  write(*,*)'SMC lon, lat, lev:',nlon_regional_smc,nlat_regional_smc,nsig_regional_smc
  write(*,*)'Global lon, lat, lev:',nlon_regional,nlat_regional,nsig_regional
  allocate(field3(nlon_regional_smc,nlat_regional_smc,nsig_regional_smc))
  write(*,*)'Before reading SMC (SMOIS) from file ',sfcvars
  call gsi_fv3ncdf_read(sfcvars,'smc','SMC',field3,mype)
  write(*,*)'Done with reading SMC (SMOIS) from file ',sfcvars
  do k=1,nsig_regional_smc
